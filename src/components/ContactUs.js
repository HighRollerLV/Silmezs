    ...
    return (
        <div className="bg-customGray p-8 md:p-32 text-customDark">
            <div className="flex flex-col lg:flex-row gap-6 md:gap-10">
                <div className="w-full lg:w-1/2 mb-6 md:mb-0 text-customGray bg-customDark px-4 md:px-6 py-4 md:py-6 rounded-md">
                    <h2 className="text-3xl md:text-5xl font-semibold mb-3 md:mb-4">Contact Information</h2>
