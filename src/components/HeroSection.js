...
const HeroSection = () => {
    ...
    return (
        <div className="relative">
            <img src="/images/HeroSection.jpg" alt="Interior" className="w-full h-auto min-h-[800px] object-cover"/>
            ...
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center p-4">
                <img src="/images/Amarant.jpg" alt="Silmežs Logo"
                     className="mx-auto w-full min-w-[300px] h-auto min-h-[250px] object-contain"/>
